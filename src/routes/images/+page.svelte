<script lang='ts'>
	import { createMediaPrompts, generateImage, generateLogicalChunksForImageContext, generateTranscript, type EnrichedLogicalChunk, type LogicalChunk } from "$lib/api/ai";
